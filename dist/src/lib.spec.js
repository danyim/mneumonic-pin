...
describe("generateSeed", () => {
    it("should generate a seed", () => {
        const result = lib_1.generateSeed();
    ...
    it("should generate variable # of words", () => {
        ...
        lengths.forEach((len) => {
            expect(lib_1.generateSeed(len).split(" ")).toHaveLength(len);
        });
    });
});
describe("rotateSeed", () => {
    it("should rotate a seed with a pin", () => {
        ...
        const pin = "1234";
        const result = lib_1.rotateSeed(seed, pin);
...
describe("unrotateSeed", () => {
    it("should unrotate a seed with a pin", () => {
        ...
        const pin = "1234";
        const result = lib_1.unrotateSeed(seed, pin);
        expect(result).toEqual(expected);
    });
});
